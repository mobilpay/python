...
class Invoice:
    ...
    def load_from_xml(self, invoice_node):
        ...
        if self._currency is None:
            raise Exception("Invoice.load_from_xml failed; currency attribute is missing" + str(self.ERROR_LOAD_FROM_XML_CURRENCY_ATTR_MISSING))

        self._amount = invoice_node.getAttribute("amount")
        if self._amount is None:
            raise Exception("Invoice.load_from_xml failed; amount attribute is missing")
    ...
    def create_xml_element(self, document):
        ...
        if self._currency is None:
            raise Exception("Invalid currency " + str(self.ERROR_INVALID_CURRENCY))
