...
class Notify:
    ...
    def create_xml_element(self, document):
        ...
        if self.paymentInstrumentId is not None:
            xml_notify.appendChild(self.create_text_element(xml_notify, "payment_instrument_id", self.current_payment_count))
        ...
        if self.token_expiration_date is not None:
            xml_notify.appendChild(self.create_text_element(xml_notify, "token_expiration_date", self.token_expiration_date))
